...
CLI 会自动检测你使用的 AI 编码工具（Claude Code / CodeBuddy / Cursor / Codex），并安装对应格式的技能文件。也可以手动指定：
...
> Claude Code 和 CodeBuddy 安装后所有技能自动注册为原生斜杠命令，直接使用即可。
> Cursor / 其他工具：告诉 AI "按照 dev 技能的流程执行"。
